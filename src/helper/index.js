...
exports.paymentMethod = async (name, price, idUser, idTour,startDate,endDate, next) => {
  const create_payment_json = {
    ...
    redirect_urls: {
      ...
      return_url: `https://fe-travelapp-r3380i4km-giahuy08.vercel.app/booktour/payment?price=${price}&idUser=${idUser}&idTour=${idTour}&startDate=${startDate}&endDate=${endDate}`,
